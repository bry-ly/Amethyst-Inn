            ...
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="max-w-2xl mx-auto">
                  <div className=" dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 md:p-8 lg:p-10 text-center transition-colors duration-200">
                    {/* Quote */}
                    <blockquote className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-normal leading-relaxed mb-4 sm:mb-6 md:mb-8 font-roboto italic">
                      "{testimonial.quote}"
                    </blockquote>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 font-roboto mt-1">
                        {testimonial.role}
                      </p>
                      {testimonial.location && (
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-500 font-roboto mt-1">
                          {testimonial.location}
                        </p>
                      )}
                    </div>
